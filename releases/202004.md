...
- **Audio payload support**: As an alternative to sending text and audio with base64 encoding, it is now possible to use an audio URL when interacting with our virtual devices through their HTTP API. Read (here)[/end-to-end/api/#http-api] to know how to do it.
...
## Others
### IVR Docs
We have updated our documentation site by including instructions on how to perform end-to-end tests for IVR systems. You can read more about it (here)[/end-to-end/ivr/].
