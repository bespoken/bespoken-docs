...
### Alexa
To learn in detail how to add more tests and other advanced topics, read our [In-depth guide for Alexa](./guide).
Also, learn about other common use-cases [here](./use-cases), such as:
...
### Google
To learn in detail how to add more tests and other advanced topics, read our [In-depth guide for Google](./guide-google).
